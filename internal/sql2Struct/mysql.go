...
func NewDBModel(info *DBInfo) *DBModle {
	return &DBModle{DBInfo: info}
}

func (m *DBModle) Connect() error {
	var err error
	dsn := fmt.Sprintf(
...
func (m *DBModle) GetColums(dbName, tableName string) ([]*TableColumn, error) {
